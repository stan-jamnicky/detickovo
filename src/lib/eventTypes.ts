...
export const EVENT_TYPES: EventTypeInfo[] = [
  ...
  { id: 'skola-skolka', label: 'Zaklandá Škola / Materská Škola', short: 'Karnevaly, školské akcie a programy na mieru.', href: '/velke-akcie', color: 'var(--color-brand-green)', icon: '🎒' },
